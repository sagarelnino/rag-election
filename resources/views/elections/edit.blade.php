        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card mt-4" style="background: #d5eadb">
                    <div class="card-header">Update the information below</div>

                    <div class="card-body">
                        <form method="POST" action="/election/{{ $election->id }}">
                            @method('patch')
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="title" type="text"
                                        ...
                                        value="{{ $election->title }}" placeholder="Enter a title for this election"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="start_time" type="datetime-local" value="{{ $election->start_time }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="end_time" type="datetime-local" value="{{ $election->end_time }}"
